...
TEST_VEHICLE = os.getenv("TEST_VEHICLE", "vehicle.lincoln.mkz2017") 
...
class RouteScenario(BasicScenario):
    ...
    def _update_ego_vehicle(self):
        ...
        ego_vehicle = CarlaDataProvider.request_new_actor(TEST_VEHICLE,
                                                          elevate_transform,
                                                          rolename='hero')
    ...
    def _build_scenario_instances(self, world, ego_vehicle, scenario_definitions,
        ...
        for scenario_number, definition in enumerate(scenario_definitions):
            ...
            scenario_configuration.ego_vehicles = [ActorConfigurationData(TEST_VEHICLE,
